...
report_path = os.path.join(RUNS_DIR, f"run_{run_timestamp}.txt")
...
X_val = X_flat[train_end:val_end]
y_val = y[train_end:val_end]

X_test = X_flat[val_end:]
y_test = y[val_end:]
...
log_print(report_lines, f"Val Accuracy: {val_acc}")
log_print(report_lines, f"Test Accuracy: {test_acc}")
